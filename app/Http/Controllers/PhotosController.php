...
class PhotosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('photos.category', [$photo->category_id])->with('success', 'Photo has been uploaded successfully.');
    }
    ...
    public function update(Request $request, $photo_id)
    {
        ...
        return redirect()->route('photos.category', [$photo->category_id])->with('success', 'Selected photo has been updated successfully');
    }
